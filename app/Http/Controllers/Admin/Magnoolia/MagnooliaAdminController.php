...
class MagnooliaAdminController extends Controller
{
    ...
    public function updateCampaign(Request $request)
    {
        $validated = $request->validate([
            ...
            'campaign_note_short_et' => 'nullable|string|max:255',
            'campaign_note_short_ru' => 'nullable|string|max:255',
            'campaign_note_short_en' => 'nullable|string|max:255',
            'campaign_legal_note' => 'nullable|string|max:500',
            'campaign_legal_note_ru' => 'nullable|string|max:500',
            'campaign_legal_note_en' => 'nullable|string|max:500',
        ...
        $payload = [
            ...
            'campaign_note_short_et' => $validated['campaign_note_short_et'] ?? null,
            'campaign_note_short_ru' => $validated['campaign_note_short_ru'] ?? null,
            'campaign_note_short_en' => $validated['campaign_note_short_en'] ?? null,
            'campaign_legal_note' => $validated['campaign_legal_note'] ?? null,
            'campaign_legal_note_ru' => $validated['campaign_legal_note_ru'] ?? null,
            'campaign_legal_note_en' => $validated['campaign_legal_note_en'] ?? null,
