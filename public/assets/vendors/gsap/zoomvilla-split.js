  ...
  function bwsplit_text() {
    setTimeout(function () {
      var splitTextElements = $(
        ".sec-title__title, .sec-title__tagline, .bw-split-in-fade, .bw-split-in-right, .bw-split-in-left, .bw-split-in-up, .bw-split-in-down, .bw-split-in-up-fast, .bw-split-in-rotate, .bw-split-in-scale"
      );
