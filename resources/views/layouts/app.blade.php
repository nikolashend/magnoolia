...
<head>
    ...
    <!-- Favicon Icons -->
    @php $favV = @filemtime(public_path('assets/images/favicons/favicon-32x32.png')) ?: 1; @endphp
    <link rel="icon" href="{{ asset('favicon.ico') }}?v={{ $favV }}" sizes="any">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('assets/images/favicons/apple-touch-icon.png') }}?v={{ $favV }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('assets/images/favicons/favicon-32x32.png') }}?v={{ $favV }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('assets/images/favicons/favicon-16x16.png') }}?v={{ $favV }}">
