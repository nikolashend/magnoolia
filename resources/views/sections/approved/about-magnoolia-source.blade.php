    ...
    <section class="about-one section-space" id="why-magnoolia" style="background-color:#ffffff;">
        <div class="container">
            <div class="row gutter-y-50">
                <div class="col-lg-7 wow fadeInLeft" data-wow-duration="1500ms" data-wow-delay="300ms">
                    <div class="about-one__image">
                        <div class="about-one__image__item">
                            <div class="about-one__image__item__inner hover:shine" style="overflow:hidden;width:72%;aspect-ratio:52/61;">
                                <img {!! mg_img('Cam004.0000.jpg', '(min-width:992px) 40vw, 100vw') !!} alt="Magnoolia ridaelamud välisvaade" class="about-one__image__one" style="width:100%;height:100%;object-fit:cover;object-position:center;display:block;" loading="lazy" decoding="async">
                            </div>
                        ...
                        <div class="about-one__image__item-two hover:shine" style="width:59%;aspect-ratio:43/55;">
                            <div class="about-one__image__icon">
                                <img src="{{ asset('assets/images/shapes/house-1-1.png') }}" alt="" loading="lazy" decoding="async">
                            </div>
                            <img {!! mg_img('Interior 4.jpg', '(min-width:992px) 32vw, 100vw') !!} alt="Magnoolia sisevaade" class="about-one__image__one" style="width:100%;height:100%;object-fit:cover;display:block;" loading="lazy" decoding="async">
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
